...
public class SysRegisterService
{
    ...
    public String register(RegisterBody registerBody)
    {
        ...
        else if (StringUtils.isNotEmpty(nickName) && nickName.length() > 30)
        {
            msg = "用户名长度不能超过30个字符";
        }
        else if (StringUtils.isNotEmpty(phonenumber) && phonenumber.length() > 11)
        {
            msg = "手机号码长度不能超过11个字符";
        }
        ...
        else
        {
            if (StringUtils.isNotEmpty(phonenumber))
            {
                ...
                if (UserConstants.NOT_UNIQUE.equals(userService.checkPhoneUnique(phoneUser)))
                {
            ...
            sysUser.setPhonenumber(StringUtils.isNotEmpty(phonenumber) ? phonenumber : username);
