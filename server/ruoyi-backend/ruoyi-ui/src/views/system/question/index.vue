  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="链接类型" prop="urlType">
        <el-select v-model="queryParams.urlType" placeholder="请选择链接类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="链接类型" align="center" prop="urlType">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除案例题库编号为"' + ids + '"的数据项？').then(function() {
