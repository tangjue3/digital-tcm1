<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="医药馆或者医院名称" prop="name">
        <el-input
          v-model="queryParams.name"
          placeholder="请输入医药馆或者医院名称"
          clearable
    ...
    <el-table v-loading="loading" :data="shopList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="医药馆或者医院名称" align="center" prop="name" />
      <el-table-column label="详细地址" align="center" prop="address" />
      <el-table-column label="坐标" align="center" prop="coordinate" />
      <el-table-column label="介绍" align="center" prop="introduce" />
      <el-table-column label="药店照片" align="center" prop="coverImage" width="100">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="医药馆或者医院名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入医药馆或者医院名称" />
        </el-form-item>
        <el-form-item label="详细地址" prop="address">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除中医房编号为"' + ids + '"的数据项？').then(function() {
        return delShop(ids);
      }).then(() => {
        this.getList();
